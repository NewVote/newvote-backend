...
gulp.task('watch', function (done) {
    ...
    gulp.watch(defaultAssets.server.allJS, gulp.series('lint')).on(
        'change',
        plugins.livereload.changed,
    )
...
gulp.task(
    'protractor',
    gulp.series('webdriver_update', function () {
        gulp.src([])
            .pipe(
                protractor({
...
gulp.task(
    'test:server',
    gulp.series('env:test', 'debug:false', 'lint', 'mocha'),
)
